...
const BattleScreen = ({ section }: BattleScreenProps) => {
  ...
  const ProfileCard = ({ profile, onVote }: { profile: ProfileData; onVote: () => void }) => (
    <motion.div
      ...
      className="bg-white rounded-3xl shadow-lg p-8 flex flex-col items-center relative cursor-pointer hover:shadow-xl transition-shadow max-w-lg mx-auto w-full"
      onClick={onVote}
    >
      {/* Profile Image */}
      <motion.div 
        className="w-44 h-44 rounded-full overflow-hidden mb-6 border-4 border-white shadow-lg"
      ...
      <div className="text-center w-full">
        ...
        <div className="space-y-3 text-left">
          {[profile.bio, ...profile.interests].map((point, idx) => (
            ...
            >
              <span className="text-gray-400 mt-1.5 text-lg">○</span>
        ...
        <div className="mt-8">
          <a 
            ...
            className="inline-block text-gray-600 hover:text-gray-800 transition-colors scale-125"
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-white overflow-hidden">
      {/* Main Content */}
      <main className="flex-1 max-w-[90rem] mx-auto px-8 flex flex-col justify-center">
        {/* Title */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-48 max-w-[80rem] mx-auto relative">
          ...
          <div className="hidden md:flex absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
            <div className="bg-rose-500 text-white px-10 py-5 rounded-full font-bold text-xl shadow-xl">
              VS
            </div>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="text-center py-3 text-gray-400 text-sm">
